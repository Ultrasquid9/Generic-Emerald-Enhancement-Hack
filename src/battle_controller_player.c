...
static const u16 sSplitIcons_Pal[] = INCBIN_U16("graphics/battle_interface/pss_icons_battle.gbapal");
static const u8 sSplitIcons_Gfx[] = INCBIN_U8("graphics/battle_interface/pss_icons_battle.4bpp");
